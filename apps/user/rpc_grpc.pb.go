...
const (
	RPC_ListUser_FullMethodName     = "/gokade.mcenter.user.RPC/ListUser"
	RPC_DescribeUser_FullMethodName = "/gokade.mcenter.user.RPC/DescribeUser"
)
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gokade.mcenter.user.RPC",
