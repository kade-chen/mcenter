...
type IssueTokenRequest struct {
	...
	GrantType GRANT_TYPE `protobuf:"varint,1,opt,name=grant_type,json=grantType,proto3,enum=gokade.mcenter.token.GRANT_TYPE" json:"grant_type"`
	// 令牌类型
	// @gotags: json:"type"
	Type TOKEN_TYPE `protobuf:"varint,2,opt,name=type,proto3,enum=gokade.mcenter.token.TOKEN_TYPE" json:"type"`
	// 令牌过期时间
...
type Token struct {
	...
	// 颁发平台, 根据授权方式判断
	// @gotags: bson:"platform" json:"platform"
	Platform PLATFORM `protobuf:"varint,1,opt,name=platform,proto3,enum=gokade.mcenter.token.PLATFORM" json:"platform" bson:"platform"`
	// 访问令牌
	...
	UserType user.TYPE `protobuf:"varint,7,opt,name=user_type,json=userType,proto3,enum=gokade.mcenter.user.TYPE" json:"user_type" bson:"user_type"`
	// 用户当前所处域
	...
	GrantType GRANT_TYPE `protobuf:"varint,11,opt,name=grant_type,json=grantType,proto3,enum=gokade.mcenter.token.GRANT_TYPE" json:"grant_type" bson:"grant_type"`
	// 令牌类型
	// @gotags: bson:"type" json:"type"
	Type TOKEN_TYPE `protobuf:"varint,12,opt,name=type,proto3,enum=gokade.mcenter.token.TOKEN_TYPE" json:"type" bson:"type"`
	// 当前空间
...
type Status struct {
	...
	BlockType BLOCK_TYPE `protobuf:"varint,2,opt,name=block_type,json=blockType,proto3,enum=gokade.mcenter.token.BLOCK_TYPE" json:"block_type" bson:"block_type"`
	// 冻结时间
...
var file_mcenter_apps_token_pb_token_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x1f, 0x6d, 0x63, 0x65, 0x6e, 0x74,
	0x65, 0x72, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x2f,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa8, 0x04, 0x0a, 0x11, 0x49,
	...
	,
	...
	0x6f, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3e, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x67, 0x6f, 0x6b, 0x61,
	0x64, 0x65, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72,
	0x41, 0x67, 0x65, 0x6e, 0x74, 0x22, 0x9d, 0x01, 0x0a, 0x0a, 0x49, 0x50, 0x4c, 0x6f, 0x63, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x8b, 0x07, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x3a, 0x0a,
	0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x1e, 0x2e, 0x67, 0x6f, 0x6b, 0x61, 0x64, 0x65, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72,
	0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x50, 0x4c, 0x41, 0x54, 0x46, 0x4f, 0x52, 0x4d, 0x52,
	0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x63,
	...
	0x6e, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x73, 0x75, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x04, 0x20,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f,
	0x6b, 0x61, 0x64, 0x65, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x3a, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x12, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x67, 0x6f, 0x6b, 0x61, 0x64, 0x65, 0x2e, 0x6d, 0x63, 0x65,
	...
	0x04, 0x6d, 0x65, 0x74, 0x61, 0x18, 0x13, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x67, 0x6f,
	0x6b, 0x61, 0x64, 0x65, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x45, 0x6e, 0x74,
	...
	,
	...
	0x55, 0x10, 0x08, 0x12, 0x0c, 0x0a, 0x08, 0x44, 0x49, 0x4e, 0x47, 0x44, 0x49, 0x4e, 0x47, 0x10,
	0x09, 0x12, 0x10, 0x0a, 0x0c, 0x46, 0x4f, 0x52, 0x57, 0x41, 0x52, 0x44, 0x5f, 0x41, 0x55, 0x54,
	0x48, 0x10, 0x0a, 0x2a, 0x2a, 0x0a, 0x0a, 0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x5f, 0x54, 0x59, 0x50,
	...
	0x1c, 0x0a, 0x08, 0x50, 0x4c, 0x41, 0x54, 0x46, 0x4f, 0x52, 0x4d, 0x12, 0x07, 0x0a, 0x03, 0x57,
	0x45, 0x42, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x50, 0x49, 0x10, 0x01, 0x2a, 0x5a, 0x0a,
	...
	0x47, 0x47, 0x45, 0x44, 0x5f, 0x49, 0x4e, 0x10, 0x02, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74,
...
var file_mcenter_apps_token_pb_token_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_mcenter_apps_token_pb_token_proto_goTypes = []interface{}{
	(GRANT_TYPE)(0),           // 0: gokade.mcenter.token.GRANT_TYPE
	(TOKEN_TYPE)(0),           // 1: gokade.mcenter.token.TOKEN_TYPE
	(PLATFORM)(0),             // 2: gokade.mcenter.token.PLATFORM
	(BLOCK_TYPE)(0),           // 3: gokade.mcenter.token.BLOCK_TYPE
	(*IssueTokenRequest)(nil), // 4: gokade.mcenter.token.IssueTokenRequest
	(*Location)(nil),          // 5: gokade.mcenter.token.Location
	(*IPLocation)(nil),        // 6: gokade.mcenter.token.IPLocation
	(*UserAgent)(nil),         // 7: gokade.mcenter.token.UserAgent
	(*Token)(nil),             // 8: gokade.mcenter.token.Token
	(*Status)(nil),            // 9: gokade.mcenter.token.Status
	nil,                       // 10: gokade.mcenter.token.Token.MetaEntry
	(user.TYPE)(0),            // 11: gokade.mcenter.user.TYPE
}
var file_mcenter_apps_token_pb_token_proto_depIdxs = []int32{
	0,  // 0: gokade.mcenter.token.IssueTokenRequest.grant_type:type_name -> gokade.mcenter.token.GRANT_TYPE
	1,  // 1: gokade.mcenter.token.IssueTokenRequest.type:type_name -> gokade.mcenter.token.TOKEN_TYPE
	5,  // 2: gokade.mcenter.token.IssueTokenRequest.location:type_name -> gokade.mcenter.token.Location
	6,  // 3: gokade.mcenter.token.Location.ip_location:type_name -> gokade.mcenter.token.IPLocation
	7,  // 4: gokade.mcenter.token.Location.user_agent:type_name -> gokade.mcenter.token.UserAgent
	2,  // 5: gokade.mcenter.token.Token.platform:type_name -> gokade.mcenter.token.PLATFORM
	11, // 6: gokade.mcenter.token.Token.user_type:type_name -> gokade.mcenter.user.TYPE
	0,  // 7: gokade.mcenter.token.Token.grant_type:type_name -> gokade.mcenter.token.GRANT_TYPE
	1,  // 8: gokade.mcenter.token.Token.type:type_name -> gokade.mcenter.token.TOKEN_TYPE
	9,  // 9: gokade.mcenter.token.Token.status:type_name -> gokade.mcenter.token.Status
	5,  // 10: gokade.mcenter.token.Token.location:type_name -> gokade.mcenter.token.Location
	10, // 11: gokade.mcenter.token.Token.meta:type_name -> gokade.mcenter.token.Token.MetaEntry
	3,  // 12: gokade.mcenter.token.Status.block_type:type_name -> gokade.mcenter.token.BLOCK_TYPE
