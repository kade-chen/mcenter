...
const (
	RPC_DescribeDomain_FullMethodName = "/gokade.mcenter.domain.RPC/DescribeDomain"
	RPC_QueryDoamin_FullMethodName    = "/gokade.mcenter.domain.RPC/QueryDoamin"
)
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gokade.mcenter.domain.RPC",
