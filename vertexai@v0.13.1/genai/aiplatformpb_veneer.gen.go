...
const (
	...
	// HarmBlockOFF means harm block is turned off.
	HarmBlockOFF HarmBlockThreshold = 5
)
...
const (
	...
	HARM_CATEGORY_CIVICINTEGRITY HarmCategory = 5
)
...
var namesForHarmCategory = map[HarmCategory]string{
	...
	HARM_CATEGORY_CIVICINTEGRITY: "HARM_CATEGORY_CIVICINTEGRITY",
}
